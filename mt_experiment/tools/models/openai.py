...
def openai_gpt4o_mini(prompt):
    return openai_call(prompt, "gpt-4o-mini")

def openai_gpt4o_mini_finetuned(prompt):
    return openai_call(prompt, "ft:gpt-4o-mini-2024-07-18:cl-uzh:mediomatix-multilingual-v2:BxbuTBRp")
